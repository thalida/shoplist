...
const documents = {
    ...
    "query AllProducts($first: Int, $after: String, $last: Int, $before: String, $orderBy: String, $uid: UUID, $name: String, $name_Icontains: String, $categories: [ID], $store: [ID], $list: [ID]) {\n  allProducts(\n    first: $first\n    after: $after\n    last: $last\n    before: $before\n    orderBy: $orderBy\n    uid: $uid\n    name: $name\n    name_Icontains: $name_Icontains\n    categories: $categories\n    stores: $store\n    lists: $list\n  ) {\n    totalCount\n    pageInfo {\n      hasNextPage\n      hasPreviousPage\n      startCursor\n      endCursor\n    }\n    edges {\n      node {\n        uid\n        name\n        categories {\n          edges {\n            node {\n              uid\n              name\n              color\n            }\n          }\n        }\n        stores {\n          edges {\n            node {\n              uid\n              name\n            }\n          }\n        }\n        lists {\n          edges {\n            node {\n              uid\n              name\n            }\n          }\n        }\n      }\n    }\n  }\n}": types.AllProductsDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query AllProducts($first: Int, $after: String, $last: Int, $before: String, $orderBy: String, $uid: UUID, $name: String, $name_Icontains: String, $categories: [ID], $store: [ID], $list: [ID]) {\n  allProducts(\n    first: $first\n    after: $after\n    last: $last\n    before: $before\n    orderBy: $orderBy\n    uid: $uid\n    name: $name\n    name_Icontains: $name_Icontains\n    categories: $categories\n    stores: $store\n    lists: $list\n  ) {\n    totalCount\n    pageInfo {\n      hasNextPage\n      hasPreviousPage\n      startCursor\n      endCursor\n    }\n    edges {\n      node {\n        uid\n        name\n        categories {\n          edges {\n            node {\n              uid\n              name\n              color\n            }\n          }\n        }\n        stores {\n          edges {\n            node {\n              uid\n              name\n            }\n          }\n        }\n        lists {\n          edges {\n            node {\n              uid\n              name\n            }\n          }\n        }\n      }\n    }\n  }\n}"): (typeof documents)["query AllProducts($first: Int, $after: String, $last: Int, $before: String, $orderBy: String, $uid: UUID, $name: String, $name_Icontains: String, $categories: [ID], $store: [ID], $list: [ID]) {\n  allProducts(\n    first: $first\n    after: $after\n    last: $last\n    before: $before\n    orderBy: $orderBy\n    uid: $uid\n    name: $name\n    name_Icontains: $name_Icontains\n    categories: $categories\n    stores: $store\n    lists: $list\n  ) {\n    totalCount\n    pageInfo {\n      hasNextPage\n      hasPreviousPage\n      startCursor\n      endCursor\n    }\n    edges {\n      node {\n        uid\n        name\n        categories {\n          edges {\n            node {\n              uid\n              name\n              color\n            }\n          }\n        }\n        stores {\n          edges {\n            node {\n              uid\n              name\n            }\n          }\n        }\n        lists {\n          edges {\n            node {\n              uid\n              name\n            }\n          }\n        }\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
